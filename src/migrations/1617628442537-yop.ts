...
export class yop1617628442537 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "activity" ("id" SERIAL NOT NULL, "type" character varying NOT NULL, "ip_address" character varying NOT NULL, CONSTRAINT "UQ_f27285af15ef48363745ab2d792" UNIQUE ("type"), CONSTRAINT "PK_24625a1d6b1b089c8ae206fe467" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "shop" ("id" SERIAL NOT NULL, "handle" character varying NOT NULL, "name" character varying NOT NULL, "description" character varying NOT NULL, "ownerId" integer, CONSTRAINT "UQ_c610b2d2fbea8feab8c5b006c89" UNIQUE ("handle"), CONSTRAINT "PK_ad47b7c6121fe31cb4b05438e44" PRIMARY KEY ("id"))`);
